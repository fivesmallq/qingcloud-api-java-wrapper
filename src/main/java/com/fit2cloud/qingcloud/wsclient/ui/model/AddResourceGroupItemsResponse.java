...
public class AddResourceGroupItemsResponse {
	...
	public static AddResourceGroupItemsResponse fromJson(String jsonAddLoadBalancerListenersResponse){
		Gson gson = new Gson();
		AddResourceGroupItemsResponse addLoadBalancerListenersResponse = gson.fromJson(jsonAddLoadBalancerListenersResponse, AddResourceGroupItemsResponse.class);
